                            ...
                            <tr class="border-b hover:bg-gray-100">
                                <td class="w-4 px-4 py-3 items-center justify-end relative" x-data="{ open: false, dropdownPosition: 'bottom' }"
                                    ...
                                    <div x-show="open" x-transition
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button-<?php echo e($banner->image); ?>">
                                            <li>
                                                <a href="/dashboard/banners/<?php echo e($banner->id); ?>/edit"
                                            ...
                                            <li>
                                                <a href="/dashboard/banners/<?php echo e($banner->id); ?>"
                                                    class="flex w-full items-center py-2 px-4 hover:bg-gray-100 text-gray-700">
                                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            ...
                                            <li>
                                                <form action="/dashboard/banners/<?php echo e($banner->id); ?>" method="POST"
                                                    id="deleteForm-<?php echo e($banner->id); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="button"
                                                        onclick="confirmDelete('<?php echo e($banner->id); ?>')"
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                    <?php echo e($banner->updated_at->diffForHumans()); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\projek-kkp\resources\views/dashboard/banners/index.blade.php ENDPATH**/ ?>
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                <td class="w-4 px-4 py-3 items-center justify-end relative" x-data="{ open: false, dropdownPosition: 'bottom' }"
                                    ...
                                    <div x-show="open" x-transition
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button-<?php echo e($size->name); ?>">
                                            <li>
                                                <a href="/dashboard/sizes/<?php echo e($size->id); ?>/edit"
                                            ...
                                            <li>
                                                <form action="/dashboard/sizes/<?php echo e($size->id); ?>" method="POST"
                                                    id="deleteForm-<?php echo e($size->id); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="button" onclick="confirmDelete(<?php echo e($size->id); ?>)"
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($size->name); ?></td>
                                <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($size->updated_at); ?></td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\projek-kkp\resources\views/dashboard/sizes/index.blade.php ENDPATH**/ ?>
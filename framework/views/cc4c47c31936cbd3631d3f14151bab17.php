...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        <!-- Form -->
        <form action="/dashboard/products/<?php echo e($product->slug); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select name="sizes_id" id="size"
                        class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="" disabled <?php echo e(old('sizes_id') ? '' : 'selected'); ?>>Select a size</option>
                        <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($size->id); ?>"
                                <?php echo e(old('sizes_id', $product->sizes_id) == $size->id ? 'selected' : ''); ?>>
                                <?php echo e($size->name); ?>

                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php $__errorArgs = ['sizes_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    <label for="color" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product
                        Color</label>
                    <input type="text" name="color" id="color" value="<?php echo e(old('color', $product->color)); ?>"
                        class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="image">Upload
                    Image</label>
                <input type="hidden" name="oldImage" value="<?php echo e($product->image); ?>" < class="flex items-start">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\projek-kkp\resources\views/dashboard/Products/edit.blade.php ENDPATH**/ ?>
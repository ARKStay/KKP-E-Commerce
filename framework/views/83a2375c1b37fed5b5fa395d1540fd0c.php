                    ...
                    <tbody>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b hover:bg-gray-100">
                                <td class="w-4 px-4 py-3 items-center justify-end relative" x-data="{ open: false, dropdownPosition: 'bottom' }"
                                    ...
                                    <div x-show="open" x-transition
                                        ...
                                        <ul class="py-1 text-sm"
                                            aria-labelledby="dropdown-button-<?php echo e($category->name); ?>">
                                            <li>
                                            ...
                                            <li>
                                                <form action="/dashboard/categories/<?php echo e($category->id); ?>" method="POST"
                                                    id="deleteForm-<?php echo e($category->id); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="button" onclick="confirmDelete(<?php echo e($category->id); ?>)"
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($category->updated_at); ?></td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\projek-kkp\resources\views/dashboard/categories/index.blade.php ENDPATH**/ ?>
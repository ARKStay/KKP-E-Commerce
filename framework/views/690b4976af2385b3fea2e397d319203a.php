...
<?php $component->withAttributes([]); ?>
    <div class="space-y-4 mt-10">
        <a href="/dashboard" class="px-6 py-3 text-white bg-blue-500 rounded-lg hover:bg-blue-600">Dashboard
            Admin</a>
        <a href="" class="px-6 py-3 text-white bg-green-500 rounded-lg hover:bg-green-600">Login</a>
    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\projek-kkp\resources\views/contoh.blade.php ENDPATH**/ ?>
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        @auth
                            ...
                            <x-layouts.nav-link href="/user/about" :active="request()->is('user/about')">About</x-layouts.nav-link>
                            <x-layouts.nav-link href="/user/contact" :active="request()->is('user/contact')">Contact</x-layouts.nav-link>
                        @else
                            ...
                            <x-layouts.nav-link href="/about" :active="request()->is('about')">About</x-layouts.nav-link>
                            <x-layouts.nav-link href="/contact" :active="request()->is('contact')">Contact</x-layouts.nav-link>
                        @endauth
                    </div>
                </div>
            </div>
    ...
    <div x-show="isOpen" class="md:hidden">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            @auth
                ...
                <x-layouts.nav-link-m href="/user/about" :active="request()->is('user/about')">About</x-layouts.nav-link-m>
                <x-layouts.nav-link-m href="/user/contact" :active="request()->is('user/contact')">Contact</x-layouts.nav-link-m>
            @else
                ...
                <x-layouts.nav-link-m href="/about" :active="request()->is('about')">About</x-layouts.nav-link-m>
                <x-layouts.nav-link-m href="/contact" :active="request()->is('contact')">Contact</x-layouts.nav-link-m>
            @endauth
        </div>
